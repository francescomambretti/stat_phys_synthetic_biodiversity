...
if key1=="oligo1":
    ...
    mother_folder="../data/oligo1_proto06/" # where to take FASTQ files from
    if (key_filter==False and key_no_cut==False):
        results_folder=results_folder+"oligo1_proto06/"+key2+"_"+key3+"/min_Q_{}/".format(min_Q) # where to store results
    elif (key_filter==True and key_no_cut==False):
        results_folder=results_folder+"oligo1_proto06/"+key2+"_"+key3+"_key_filter/min_Q_{}/".format(min_Q) # where to store results
    elif (key_filter==True and key_no_cut==True):
        results_folder=results_folder+"oligo1_proto06/"+key2+"_"+key3+"_key_filter_key_no_cut/min_Q_{}/".format(min_Q) # where to store results
    elif (key_filter==False and key_no_cut==True):
        results_folder=results_folder+"oligo1_proto06/"+key2+"_"+key3+"_key_no_cut/min_Q_{}/".format(min_Q) # where to store results
    
    if key2=="R1" or key2=="R2":
        fastq_file_list=("oligo1_"+key2,"R3-06_"+key2,"R6_06_R1","R9_06_"+key2,"R12_06_"+key2,"R15_06_"+key2,"R18_06_"+key2,"R21_06_"+key2,"R24_06_"+key2) #warning! cycle R6_06_R2 does not exist!
        fastq_file_list_plot=("0_oligo1_"+key2,"1_R3-06_"+key2,"2_R6_06_R1","3_R9_06_"+key2,"4_R12_06_"+key2,"5_R15_06_"+key2,"6_R18_06_"+key2,"7_R21_06_"+key2,"8_R24_06_"+key2) #warning! cycle R6_06_R2 does not exist!
        if key2=="R1":
            cycles_IDs=np.arange(0,25,3)
        elif key2=="R2":
            cycles_IDs=np.arange(0,25,3) #cycles_IDs=(0,3,9,12,15,18,21,24) - use this in case you want to skip cycle 6
            
    elif key2=="R1R2":
        fastq_file_list_R1=("oligo1_R1","R3-06_R1","R6_06_R1","R9_06_R1","R12_06_R1","R15_06_R1","R18_06_R1","R21_06_R1","R24_06_R1")
        fastq_file_list_R2=("oligo1_R2","R3-06_R2","R6_06_R1","R9_06_R2","R12_06_R2","R15_06_R2","R18_06_R2","R21_06_R2","R24_06_R2") #warning! cycle 6 R2 does not exist - copy R1
        fastq_file_list_plot=("0_oligo1_R1R2","1_R3-06_R1R2","2_R6_06_R1R2","3_R9_06_R1R2","4_R12_06_R1R2","5_R15_06_R1R2","6_R18_06_R1R2","7_R21_06_R1R2","8_R24_06_R1R2")
        cycles_IDs=np.arange(0,25,3)
